...
#include "cc_tools_qt_plugin/cc_demo2/field/MsgId.h"
...
struct SyncLayer
{
    static QVariantMap createProps_sync(bool serHidden)
    {
        ...
        using Field = ::cc_demo2::frame::FrameLayers<cc_tools_qt_plugin::cc_demo2::options::DefaultOptions>::SyncMembers::Sync;
        return
...
struct SizeLayer
{
    ...
    {
        static_cast<void>(serHidden);
        using Field = ::cc_demo2::frame::FrameLayers<cc_tools_qt_plugin::cc_demo2::options::DefaultOptions>::SizeMembers::Size;
        return
            cc_tools_qt::property::field::ForField<Field>()
                .name(Field::name())
                .serialisedHidden(serHidden)
...
struct IdLayer
{
    ...
    {
        return cc_tools_qt_plugin::cc_demo2::field::createProps_msgId("MsgId", serHidden);
    }
}; // struct IdLayer
...
struct VersionLayer
{
    ...
    {
        static_cast<void>(serHidden);
        using Field = ::cc_demo2::frame::FrameLayers<cc_tools_qt_plugin::cc_demo2::options::DefaultOptions>::VersionMembers::Version;
        return
            cc_tools_qt::property::field::ForField<Field>()
                .name(Field::name())
                .serialisedHidden(serHidden)
...
struct ChecksumLayer
{
    ...
    {
        static_cast<void>(serHidden);
        using Field = ::cc_demo2::frame::FrameLayers<cc_tools_qt_plugin::cc_demo2::options::DefaultOptions>::ChecksumMembers::Checksum;
        return
            cc_tools_qt::property::field::ForField<Field>()
                .name(Field::name())
                .serialisedHidden(serHidden)
...
QVariantList createProps()
{
     ...
     props.append(VersionLayer::createProps_version(false));
